...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.human_resources_organization =
      await organizations.getHuman_resources_organization({
        transaction,
      });

    output.inventory_organization =
      await organizations.getInventory_organization({
        transaction,
      });

    output.machinery_organization =
      await organizations.getMachinery_organization({
        transaction,
      });

    output.quality_control_organization =
      await organizations.getQuality_control_organization({
        transaction,
      });

    output.raw_materials_organization =
      await organizations.getRaw_materials_organization({
        transaction,
      });

    output.suppliers_organization =
      await organizations.getSuppliers_organization({
        transaction,
      });

    output.work_orders_organization =
      await organizations.getWork_orders_organization({
        transaction,
      });
